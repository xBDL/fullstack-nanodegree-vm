        ...
        try:
            ...
            if self.path.endswith("/restaurants"):
                ...
                for restaurant in restaurants:
                    output += (f"{restaurant.name}<br />"
                               ...
                               f"<a href='/restaurants/{restaurant.id}/delete'>Delete</a><br /><br />")
                output += "</body></html>"
            ...
            ### DELETE A RESTAURANT -------------------------------------------
                ...
                if my_restaurant_query:
                    ...
                    self.send_header('Content-type', 'text/html')
                    self.end_headers()
                    output = (f"<html><body><h1>Are you sure you want to delete {my_restaurant_query.name}?"
                              f"<form method='POST' enctype='multipart/form-data' accept-charset='utf-8' action='/restaurants/{restaurant_id_path}/delete'>"
